...
if (nanoButtons.length > 0 && themeContainerPrimary) {
    nanoButtons[0].click();
}
/* for theme primary */
...
function switcherClick() {
    ...
    if (
        localStorage.primaryRGB == "42 ,16, 164" &&
    ...
    if (
        localStorage.primaryRGB == "125 ,0, 189" &&
    ...
    if (
        localStorage.primaryRGB == "4, 118, 141" &&
    ...
    if (
        localStorage.primaryRGB == "138, 0, 32" &&
    ...
    if (
        localStorage.primaryRGB == "9 ,124, 103" &&
